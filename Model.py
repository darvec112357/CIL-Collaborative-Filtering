...
def main():
    ...
    parser.add_argument('-dataName', action='store', dest='dataName', default='data_train_small.csv')
...
class Model:
    def __init__(self, args):
        ...
        start = time.time()
        self.testNeg = self.dataSet.getTestNeg(self.test, 10)
        end = time.time()
        print(end-start)
        print('testneg obtained\n')
        self.add_embedding_matrix()
        print('embedding_matrix added\n')
    ...
    def add_placeholders(self):
        ...
        self.user = tf.compat.v1.placeholder(tf.int32)
        self.item = tf.compat.v1.placeholder(tf.int32)
        self.rate = tf.compat.v1.placeholder(tf.float32)
        self.drop = tf.compat.v1.placeholder(tf.float32)
    ...
    def add_loss(self):
        ...
        losses = regRate * tf.math.log(self.y_) + (1 - regRate) * tf.math.log(1 - self.y_)
    ...
    def add_train_step(self):
        ...
        self.train_step = optimizer.minimize(self.loss,self.y_)
